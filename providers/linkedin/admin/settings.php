...
<div class="nsl-admin-sub-content">
    ...
    <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" novalidate="novalidate">
        ...
        <?php if ($settings->get('client_id')): ?>
            <div class="error">
                <p><?php printf(__('By replacing your existing %1$s App, users with linked %1$s accounts will no longer be able to login with %1$s.', 'nextend-facebook-connect'), 'LinkedIn'); ?></p>
                <p>
                    <a href="https://nextendweb.com/nextend-social-login-docs/provider-linkedin/#app_scoped_user_id" target="_blank"><?php _e('Find out why?', 'nextend-facebook-connect'); ?></a>
                </p>
            </div>
        <?php endif; ?>
