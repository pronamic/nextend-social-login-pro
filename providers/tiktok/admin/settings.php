...
<div class="nsl-admin-sub-content">
    ...
    <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" novalidate="novalidate">
        ...
        <table class="form-table">
            <tbody>
            <tr>
                <th scope="row"><label for="client_key"><?php _e('Client Key', 'nextend-facebook-connect'); ?>
                        - <em>(<?php _e('Required', 'nextend-facebook-connect'); ?>)</em></label>
                </th>
                <td>
                    <input name="client_key" type="text" id="client_key"
                           value="<?php echo esc_attr($settings->get('client_key')); ?>" class="regular-text">
                    <p class="description"
                       id="tagline-client_key"><?php printf(__('If you are not sure what is your %1$s, please head over to <a href="%2$s">Getting Started</a>', 'nextend-facebook-connect'), 'Client Key', $this->getUrl()); ?></p>
                </td>
            </tr>
            <tr>
                <th scope="row"><label
