<script type="text/javascript">
    window._nslDOMReady(function () {
        ...
        if (innerContainer) {
            innerContainer.classList.add('nsl-container-woocommerce-billing-layout-above-separator');
...
$style = '
    ...
    {{containerID}} .nsl-container-woocommerce-billing-layout-above-separator {
        clear: both;
    }';
?>
<style type="text/css">
