<script type="text/javascript">
    window._nslDOMReady(function () {
        ...
        if (innerContainer) {
            innerContainer.classList.add('nsl-container-custom-actions-layout-default-separator-bottom');
...
$style = '
    ...
    {{containerID}} .nsl-container-custom-actions-layout-default-separator-bottom {
        clear: both;
    }';
?>
<style type="text/css">
