<script type="text/javascript">
    window._nslDOMReady(function () {
        ...
        if (innerContainer) {
            innerContainer.classList.add('nsl-container-buddypress-register-layout-below-separator');
...
$style = '
    ...
    {{containerID}} .nsl-container-buddypress-register-layout-below-separator {
        clear: both;
    }
