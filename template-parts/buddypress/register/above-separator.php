<script type="text/javascript">
    window._nslDOMReady(function () {
        ...
        if (innerContainer) {
            innerContainer.classList.add('nsl-container-buddypress-register-layout-above-separator');
...
$style = '
    ...
    {{containerID}} .nsl-container-buddypress-register-layout-above-separator {
        clear: both;
    }';
?>
<style type="text/css">
